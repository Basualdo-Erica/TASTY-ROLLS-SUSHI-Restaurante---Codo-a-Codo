...
catalogo = Catalogo(host='gastonpralong.mysql.pythonanywhere-services.com', user='gastonpralong', password='codo_a_codo2024', database='gastonpralong$default')
...
RUTA_DESTINO = '/home/gastonpralong/mysite/static/img/'
